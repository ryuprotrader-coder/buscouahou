  ...
  return (
    <section aria-labelledby="map-title" className="px-4 mb-2 relative z-10">
      <div className="mb-3 flex items-center justify-between">
        <h2 id="map-title" className="text-lg font-display font-bold text-neutral-900">
      ...
      >
        ...
        <span
          ...
          aria-hidden="true"
        >
          <span className="bg-white text-neutral-900 font-bold px-5 py-2.5 rounded-full flex items-center gap-2 shadow-lg group-hover:scale-105 transition-transform active:scale-95">
